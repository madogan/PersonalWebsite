...
description: >-
  Traditional search engines excel at exact matches but fail to grasp user
  intent. Learn how hybrid search combines lexical and vector methods with RRF
  to build accurate, context-aware retrieval systems.
date: '2025-12-14'
tags:
  - AI
  - RAG
